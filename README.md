...
Please note that using AngularJS Material requires the use of > **AngularJS 1.3.x** to **AngularJS 1.6.x** . 
AngularJS Material is targeted for all browsers with browser versions shown below with green boxes:
